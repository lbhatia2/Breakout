...
//  Breakout
//
//  Created by Lina Bhatia on 7/28/22.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makeBall() {
        ball.removeFromParent() //remove the ball if exists
    ...
    func makePaddle() {
        paddle.removeFromParent() // remove the paddle if exists
    ...
    func makeBricks() {
        //first remove any leftover bricks (prior game)
        for brick in bricks {
            if brick.parent != nil {
